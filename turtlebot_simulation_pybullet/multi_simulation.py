...
# First part: start point to fetch point
intermediate_agents = [
...
# Second part: fetch point to goal point
final_agents = [
...
def merge_cbs_outputs(file1, file2, output_file):
    ...
    """
    # Read two yaml file for schdules
